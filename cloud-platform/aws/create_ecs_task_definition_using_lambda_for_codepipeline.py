    ...
    try:
        ...
        try:
            response = ecs_client.register_task_definition(
                executionRoleArn="arn:aws:iam::82*********4:role/ecsTaskExecutionRole",
                taskRoleArn="arn:aws:iam::82*********4:role/ecsTaskExecutionRole",
                containerDefinitions=[
                    {"name": job_data,
                     "image": "82*********4.dkr.ecr.us-east-1.amazonaws.com/" + job_data+":latest",
                     "essential": True,
                     "logConfiguration":
                     {
                         "logDriver": "awslogs",
        ...
        response = client.invoke(
            FunctionName='arn:aws:lambda:us-east-1:82*********4:function:'+job_data,
